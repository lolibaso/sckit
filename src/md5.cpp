 ...
 */
static void MD5cInit (MD5_CTX *context)
                                                /* context */
{
 ...
 */
static void MD5cUpdate (MD5_CTX *context,unsigned char *input,unsigned int inputLen)
/* context */
/* input block */
 ...
 */
static void MD5cFinal (unsigned char digest[],MD5_CTX *context)
                                 /* message digest */
                                                /* context */
{
...
void 
md5::hash( unsigned char *out, const unsigned char *in, int in_buffer_len)
{
	...
	*/
	...
	MD5cInit( md5Info );
	MD5cUpdate( md5Info, (unsigned char *)in, in_buffer_len );
	MD5cFinal( out, md5Info );
...
char* 
md5::hashstr(char* out, const unsigned char* in, int in_len) 
{
...
int main(int argc, char* argv[])
{
    ...
    if(argc < 2)
    {
        printf("usage: md5 xxx/n");
    }

	for(i=0; i<10; i++)
        sc::md5::hashstr(out, (const unsigned char*)argv[1], strlen(argv[1]));
